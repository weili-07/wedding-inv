...
const TRANSLATIONS = {
  en: {
    ...
    dressCodeFormal: "Dress Code: Smart Casual",
    weddingAttireTitle: "Wedding Attire",
    ...
    gameLede: "Can you match all our wedding memories? Flip the cards, find every pair — then unlock your RSVP for 3rd October 2026.",
  ...
  zh: {
    ...
    dressCode: "着装色系",
    dressCodeFormal: "着装要求：休闲正式",
    weddingAttireTitle: "婚礼着装",
    ...
    gameEyebrow: "婚礼小游戏",
    gameTitle: "先玩游戏再回函",
    gameLede: "你能配对所有婚礼照片吗？翻开卡片，找出每一对——然后解锁 10月3日 的回函。",
    memoryTitle: "照片配对记忆",
